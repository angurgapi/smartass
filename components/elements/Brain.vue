  ...
  methods: {
    createBrain() {
      ...
      class Brain {
        ...
        JSONstringify() {
          let neurons = JSON.parse(
            JSON.stringify(this.neurons, (key, value) => {
          ...
          let synapses = JSON.parse(
            JSON.stringify(this.synapses, (key, value) => {
          ...
          let electrons = JSON.parse(
            JSON.stringify(this.electrons, (key, value) => {
              if (key === 'brain') {
                return undefined
              }
      ...
      class Synapse {
        ...
        removeElectron(removeElectron) {
          this.electrons = this.electrons.filter(
            (electron) => electron !== removeElectron
          )
      ...
      class Electron {
        ...
        getPosition() {
          let x, y
          let progress = this.reverseDirection
            ? easeInOutQuad(this.progress)
            : easeInOutQuad(1 - this.progress)
          ...
          x =
            (this.synapse.to.x + toOffset * Math.cos(direction)) *
              (1 - progress) +
            (this.synapse.from.x - fromOffset * Math.cos(direction)) * progress
          y =
            (this.synapse.to.y + toOffset * Math.sin(direction)) *
              (1 - progress) +
            (this.synapse.from.y - fromOffset * Math.sin(direction)) * progress
        ...
        animate(progress) {
          ...
          if (this.progress > 1) {
            ...
            let randomSynapse =
              toSynpses[Math.floor(Math.random() * toSynpses.length)]
      ...
      function draw() {
        ...
        for (let synapse of brain.synapses) {
          ...
          let point2 = between(
            synapse.from,
            synapse.to,
            0.06 + (synapse.from.size - synapse.from.baseSize) * 0.06
          )
          let point3 = between(
            synapse.from,
            synapse.to,
            0.94 - (synapse.to.size - synapse.to.baseSize) * 0.06
          )
      ...
      var savedBrain = {
        ...
        synapses: [
          ...
          { from: 51, to: 44, id: 98 },
          { from: 51, to: 45, id: 99 },
          { from: 51, to: 49, id: 100 },
          { from: 51, to: 50, id: 101 },
          { from: 52, to: 33, id: 102 },
          { from: 52, to: 34, id: 103 },
          { from: 52, to: 49, id: 104 },
          { from: 52, to: 51, id: 105 },
          { from: 53, to: 32, id: 106 },
          { from: 53, to: 33, id: 107 },
          { from: 53, to: 52, id: 108 },
          { from: 54, to: 8, id: 109 },
          { from: 54, to: 32, id: 110 },
          { from: 54, to: 53, id: 111 },
          { from: 55, to: 8, id: 112 },
          { from: 55, to: 9, id: 113 },
          { from: 55, to: 31, id: 114 },
          { from: 55, to: 54, id: 115 },
          { from: 56, to: 31, id: 116 },
          { from: 56, to: 55, id: 117 },
          { from: 57, to: 14, id: 118 },
          { from: 57, to: 15, id: 119 },
          { from: 57, to: 31, id: 120 },
          { from: 57, to: 56, id: 121 },
          { from: 58, to: 15, id: 122 },
          { from: 58, to: 16, id: 123 },
          { from: 58, to: 57, id: 124 },
          { from: 59, to: 16, id: 125 },
          { from: 59, to: 17, id: 126 },
          { from: 59, to: 18, id: 127 },
          { from: 59, to: 58, id: 128 },
          { from: 60, to: 19, id: 129 },
          { from: 60, to: 20, id: 130 },
          { from: 60, to: 59, id: 131 },
          { from: 61, to: 20, id: 132 },
          { from: 61, to: 21, id: 133 },
          { from: 61, to: 22, id: 134 },
          { from: 61, to: 60, id: 135 },
          { from: 62, to: 21, id: 136 },
          { from: 62, to: 23, id: 137 },
          { from: 62, to: 61, id: 138 },
          { from: 63, to: 23, id: 139 },
          { from: 63, to: 24, id: 140 },
          { from: 63, to: 42, id: 141 },
          { from: 63, to: 62, id: 142 },
          { from: 64, to: 42, id: 143 },
          { from: 64, to: 62, id: 144 },
          { from: 64, to: 63, id: 145 },
          { from: 65, to: 44, id: 146 },
          { from: 65, to: 51, id: 147 },
          { from: 65, to: 64, id: 148 },
          { from: 66, to: 51, id: 149 },
          { from: 66, to: 52, id: 150 },
          { from: 66, to: 65, id: 151 },
          { from: 67, to: 52, id: 152 },
          { from: 67, to: 53, id: 153 },
          { from: 67, to: 66, id: 154 },
          { from: 68, to: 53, id: 155 },
          { from: 68, to: 54, id: 156 },
          { from: 68, to: 55, id: 157 },
          { from: 68, to: 67, id: 158 },
          { from: 69, to: 66, id: 159 },
          { from: 69, to: 67, id: 160 },
          { from: 69, to: 68, id: 161 },
          { from: 70, to: 64, id: 162 },
          { from: 70, to: 65, id: 163 },
          { from: 70, to: 66, id: 164 },
          { from: 70, to: 69, id: 165 },
          { from: 71, to: 62, id: 166 },
          { from: 71, to: 64, id: 167 },
          { from: 71, to: 70, id: 168 },
          { from: 72, to: 55, id: 169 },
          { from: 72, to: 56, id: 170 },
          { from: 72, to: 68, id: 171 },
          { from: 72, to: 69, id: 172 },
          { from: 73, to: 56, id: 173 },
          { from: 73, to: 69, id: 174 },
          { from: 73, to: 72, id: 175 },
          { from: 74, to: 56, id: 176 },
          { from: 74, to: 58, id: 177 },
          { from: 74, to: 73, id: 178 },
          { from: 75, to: 58, id: 179 },
          { from: 75, to: 59, id: 180 },
          { from: 75, to: 60, id: 181 },
          { from: 75, to: 74, id: 182 },
          { from: 76, to: 60, id: 183 },
          { from: 76, to: 61, id: 184 },
          { from: 76, to: 62, id: 185 },
          { from: 76, to: 71, id: 186 },
          { from: 76, to: 75, id: 187 },
          { from: 77, to: 69, id: 188 },
          { from: 77, to: 70, id: 189 },
          { from: 77, to: 71, id: 190 },
          { from: 77, to: 73, id: 191 },
          { from: 77, to: 74, id: 192 },
          { from: 77, to: 75, id: 193 },
          { from: 77, to: 76, id: 194 },
          { from: 78, to: 13, id: 195 },
          { from: 78, to: 14, id: 196 },
          { from: 78, to: 15, id: 197 },
          { from: 79, to: 12, id: 198 },
          { from: 80, to: 12, id: 199 },
          { from: 80, to: 13, id: 200 },
          { from: 80, to: 78, id: 201 },
          { from: 80, to: 79, id: 202 },
          { from: 81, to: 15, id: 203 },
          { from: 81, to: 16, id: 204 },
          { from: 81, to: 78, id: 205 },
          { from: 81, to: 80, id: 206 },
          { from: 82, to: 16, id: 207 },
          { from: 82, to: 17, id: 208 },
          { from: 82, to: 81, id: 209 },
          { from: 83, to: 80, id: 210 },
          { from: 83, to: 81, id: 211 },
          { from: 84, to: 81, id: 212 },
          { from: 84, to: 82, id: 213 },
          { from: 84, to: 83, id: 214 },
          { from: 85, to: 17, id: 215 },
          { from: 85, to: 84, id: 216 },
          { from: 86, to: 17, id: 217 },
          { from: 86, to: 18, id: 218 },
          { from: 86, to: 85, id: 219 },
          { from: 87, to: 18, id: 220 },
          { from: 87, to: 19, id: 221 },
          { from: 87, to: 86, id: 222 },
          { from: 88, to: 19, id: 223 },
          { from: 88, to: 20, id: 224 },
          { from: 88, to: 87, id: 225 },
          { from: 89, to: 18, id: 226 },
          { from: 89, to: 19, id: 227 },
          { from: 89, to: 59, id: 228 },
          { from: 89, to: 60, id: 229 }
        ]
      }
